        ...
        <div class=" mx-auto flex flex-wrap flex-row items-center justify-between">
            ...
            <div class="hidden lg:flex lg:items-center lg:w-auto w-full lg:ml-auto lg:mr-auto flex-wrap items-center text-base justify-center"
                ...
                <nav
                    ...
                    <a href="#" class="block {{ request()->is('test1') ? 'nav-link active font-medium' : 'nav-link text-serv-text' }}">How It Works</a>
                    <a href="#" class="block {{ request()->is('test2') ? 'nav-link active font-medium' : 'nav-link text-serv-text' }}">Stories</a>
                    <a href="#" class="block {{ request()->is('test3') ? 'nav-link active font-medium' : 'nav-link text-serv-text' }}">Tips</a>
                    @auth
